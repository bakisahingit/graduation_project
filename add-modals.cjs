...
// Aurora Glow'dan önce modalleri ekle
...
if (newContent !== content) {
    ...
    console.log('✅ Modaller eklendi!');
} else {
    console.log('❌ Aurora Glow bulunamadı, </body> öncesi ekleniyor...');
    const altContent = content.replace('</body>', pharmacyModals + '\n</body>');
    fs.writeFileSync(htmlPath, altContent, 'utf8');
    console.log('✅ Modaller </body> öncesine eklendi!');
}
